...
public class DTWcal2 {
    public static char getDTWselect(double[] gyrX, double[] gyrY, double[] gyrZ) {
        ...
        dtwDist[0] = DTW.getDtwDistance(MyApplication.V1[0], MyApplication.V1[0].length,
        ...
        dtwDist[1] = DTW.getDtwDistance(MyApplication.V2[0], MyApplication.V2[0].length, gyrX, gyrX.length, gyrX.length / 10)
        ...
        dtwDist[2] = DTW.getDtwDistance(MyApplication.V3[0], MyApplication.V3[0].length, gyrX, gyrX.length, gyrX.length / 10)
        ...
        dtwDist[3] = DTW.getDtwDistance(MyApplication.V4[0], MyApplication.V4[0].length, gyrX, gyrX.length, gyrX.length / 10)
                + DTW.getDtwDistance(MyApplication.V4[1], MyApplication.V4[1].length, gyrY, gyrY.length, gyrY.length / 10)
                + DTW.getDtwDistance(MyApplication.V4[2], MyApplication.V4[2].length, gyrZ, gyrZ.length, gyrZ.length / 10);
        dtwDist[4] = DTW.getDtwDistance(MyApplication.V5[0], MyApplication.V5[0].length, gyrX, gyrX.length, gyrX.length / 10)
                + DTW.getDtwDistance(MyApplication.V5[1], MyApplication.V5[1].length, gyrY, gyrY.length, gyrY.length / 10)
                + DTW.getDtwDistance(MyApplication.V5[2], MyApplication.V5[2].length, gyrZ, gyrZ.length, gyrZ.length / 10);
        dtwDist[5] = DTW.getDtwDistance(MyApplication.V6[0], MyApplication.V6[0].length, gyrX, gyrX.length, gyrX.length / 10)
                + DTW.getDtwDistance(MyApplication.V6[1], MyApplication.V6[1].length, gyrY, gyrY.length, gyrY.length / 10)
                + DTW.getDtwDistance(MyApplication.V6[2], MyApplication.V6[2].length, gyrZ, gyrZ.length, gyrZ.length / 10);

        dtwDist[6] = DTW.getDtwDistance(MyApplication.V7[0], MyApplication.V7[0].length, gyrX, gyrX.length, gyrX.length / 10)
                + DTW.getDtwDistance(MyApplication.V7[1], MyApplication.V7[1].length, gyrY, gyrY.length, gyrY.length / 10)
                + DTW.getDtwDistance(MyApplication.V7[2], MyApplication.V7[2].length, gyrZ, gyrZ.length, gyrZ.length / 10);
        dtwDist[7] = DTW.getDtwDistance(MyApplication.V8[0], MyApplication.V8[0].length, gyrX, gyrX.length, gyrX.length / 10)
                + DTW.getDtwDistance(MyApplication.V8[1], MyApplication.V8[1].length, gyrY, gyrY.length, gyrY.length / 10)
                + DTW.getDtwDistance(MyApplication.V8[2], MyApplication.V8[2].length, gyrZ, gyrZ.length, gyrZ.length / 10);
        dtwDist[8] = DTW.getDtwDistance(MyApplication.V9[0], MyApplication.V9[0].length, gyrX, gyrX.length, gyrX.length / 10)
                + DTW.getDtwDistance(MyApplication.V9[1], MyApplication.V9[1].length, gyrY, gyrY.length, gyrY.length / 10)
                + DTW.getDtwDistance(MyApplication.V9[2], MyApplication.V9[2].length, gyrZ, gyrZ.length, gyrZ.length / 10);

        dtwDist[9] = DTW.getDtwDistance(MyApplication.V10[0], MyApplication.V10[0].length, gyrX, gyrX.length, gyrX.length / 10)
                + DTW.getDtwDistance(MyApplication.V10[1], MyApplication.V10[1].length, gyrY, gyrY.length, gyrY.length / 10)
                + DTW.getDtwDistance(MyApplication.V10[2], MyApplication.V10[2].length, gyrZ, gyrZ.length, gyrZ.length / 10);
        dtwDist[10] = DTW.getDtwDistance(MyApplication.V11[0], MyApplication.V11[0].length, gyrX, gyrX.length, gyrX.length / 10)
                + DTW.getDtwDistance(MyApplication.V11[1], MyApplication.V11[1].length, gyrY, gyrY.length, gyrY.length / 10)
                + DTW.getDtwDistance(MyApplication.V11[2], MyApplication.V11[2].length, gyrZ, gyrZ.length, gyrZ.length / 10);
        dtwDist[11] = DTW.getDtwDistance(MyApplication.V12[0], MyApplication.V12[0].length, gyrX, gyrX.length, gyrX.length / 10)
                + DTW.getDtwDistance(MyApplication.V12[1], MyApplication.V12[1].length, gyrY, gyrY.length, gyrY.length / 10)
                + DTW.getDtwDistance(MyApplication.V12[2], MyApplication.V12[2].length, gyrZ, gyrZ.length, gyrZ.length / 10);

        dtwDist[12] = DTW.getDtwDistance(MyApplication.O1[0], MyApplication.O1[0].length, gyrX, gyrX.length, gyrX.length / 10)
        ...
        dtwDist[13] = DTW.getDtwDistance(MyApplication.O2[0], MyApplication.O2[0].length, gyrX, gyrX.length, gyrX.length / 10)
        ...
        dtwDist[14] = DTW.getDtwDistance(MyApplication.O3[0], MyApplication.O3[0].length, gyrX, gyrX.length, gyrX.length / 10)
        ...
        dtwDist[15] = DTW.getDtwDistance(MyApplication.O4[0], MyApplication.O4[0].length, gyrX, gyrX.length, gyrX.length / 10)
                + DTW.getDtwDistance(MyApplication.O4[1], MyApplication.O4[1].length, gyrY, gyrY.length, gyrY.length / 10)
                + DTW.getDtwDistance(MyApplication.O4[2], MyApplication.O4[2].length, gyrZ, gyrZ.length, gyrZ.length / 10);
        dtwDist[16] = DTW.getDtwDistance(MyApplication.O5[0], MyApplication.O5[0].length, gyrX, gyrX.length, gyrX.length / 10)
                + DTW.getDtwDistance(MyApplication.O5[1], MyApplication.O5[1].length, gyrY, gyrY.length, gyrY.length / 10)
                + DTW.getDtwDistance(MyApplication.O5[2], MyApplication.O5[2].length, gyrZ, gyrZ.length, gyrZ.length / 10);
        dtwDist[17] = DTW.getDtwDistance(MyApplication.O6[0], MyApplication.O6[0].length, gyrX, gyrX.length, gyrX.length / 10)
                + DTW.getDtwDistance(MyApplication.O6[1], MyApplication.O6[1].length, gyrY, gyrY.length, gyrY.length / 10)
                + DTW.getDtwDistance(MyApplication.O6[2], MyApplication.O6[2].length, gyrZ, gyrZ.length, gyrZ.length / 10);

        dtwDist[18] = DTW.getDtwDistance(MyApplication.O7[0], MyApplication.O7[0].length, gyrX, gyrX.length, gyrX.length / 10)
                + DTW.getDtwDistance(MyApplication.O7[1], MyApplication.O7[1].length, gyrY, gyrY.length, gyrY.length / 10)
                + DTW.getDtwDistance(MyApplication.O7[2], MyApplication.O7[2].length, gyrZ, gyrZ.length, gyrZ.length / 10);
        dtwDist[19] = DTW.getDtwDistance(MyApplication.O8[0], MyApplication.O8[0].length, gyrX, gyrX.length, gyrX.length / 10)
                + DTW.getDtwDistance(MyApplication.O8[1], MyApplication.O8[1].length, gyrY, gyrY.length, gyrY.length / 10)
                + DTW.getDtwDistance(MyApplication.O8[2], MyApplication.O8[2].length, gyrZ, gyrZ.length, gyrZ.length / 10);
        dtwDist[20] = DTW.getDtwDistance(MyApplication.O9[0], MyApplication.O9[0].length, gyrX, gyrX.length, gyrX.length / 10)
                + DTW.getDtwDistance(MyApplication.O9[1], MyApplication.O9[1].length, gyrY, gyrY.length, gyrY.length / 10)
                + DTW.getDtwDistance(MyApplication.O9[2], MyApplication.O9[2].length, gyrZ, gyrZ.length, gyrZ.length / 10);
        dtwDist[21] = DTW.getDtwDistance(MyApplication.O10[0], MyApplication.O10[0].length, gyrX, gyrX.length, gyrX.length / 10)
                + DTW.getDtwDistance(MyApplication.O10[1], MyApplication.O10[1].length, gyrY, gyrY.length, gyrY.length / 10)
                + DTW.getDtwDistance(MyApplication.O10[2], MyApplication.O10[2].length, gyrZ, gyrZ.length, gyrZ.length / 10);
        dtwDist[22] = DTW.getDtwDistance(MyApplication.O11[0], MyApplication.O11[0].length, gyrX, gyrX.length, gyrX.length / 10)
                + DTW.getDtwDistance(MyApplication.O11[1], MyApplication.O11[1].length, gyrY, gyrY.length, gyrY.length / 10)
                + DTW.getDtwDistance(MyApplication.O11[2], MyApplication.O11[2].length, gyrZ, gyrZ.length, gyrZ.length / 10);
        dtwDist[23] = DTW.getDtwDistance(MyApplication.O12[0], MyApplication.O12[0].length, gyrX, gyrX.length, gyrX.length / 10)
                + DTW.getDtwDistance(MyApplication.O12[1], MyApplication.O12[1].length, gyrY, gyrY.length, gyrY.length / 10)
                + DTW.getDtwDistance(MyApplication.O12[2], MyApplication.O12[2].length, gyrZ, gyrZ.length, gyrZ.length / 10);
        ...
        map.put(dtwDist[23], 'O');
            ...
            //投票选择
        double[] mutilMin = MinNum.getMultiMinNum(dtwDist, 9);
        char re = 'q';
        double throld = 300;
        ///判断是否属于判断范围内
